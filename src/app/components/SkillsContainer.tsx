...
export default function SkillsContainer ({ skills, isOdd }: { skills: string[]; isOdd: boolean }) {
    ...
    const liClass = `text-xs xl:font-semibold sm:text-sm md:text-lg font-stretch-extra-condensed md:font-stretch-extra-expanded xl:text-2xl text-center my-auto mx-auto ${isOdd ? "text-blue-500" : "text-purple-500"}`;
    return (
